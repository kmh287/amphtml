...
// Any string that conforms to rules[i] MUST contain the string in ruleStrs[i] if ruleStrs[i] isn't empty
// We can bail out of checking the regex in rules[i] if an input doesn't contain the string at ruleStrs[i]
